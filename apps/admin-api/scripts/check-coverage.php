...
$thresholds = [
    ...
    'App\\Application\\Conferences\\Discovery\\DiscoverConferencesUseCase' => 80.0,  // Issue #200 PR-3。AutoCrawl と同パターンの Throwable catch (source/URL 単位 fail-soft 2 箇所) + dedup の集合判定で xdebug C1 が細分化。実測 86.49% (32/37)。padding なしで 100% は到達不能なので 80% に設定 (AutoCrawl と同水準)
